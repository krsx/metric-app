 ...
 * Use the [DetailSpecScadatelFragment.newInstance] factory method to
...
class DetailSpecScadatelFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DetailSpecScadatelFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DetailSpecScadatelFragment().apply {
